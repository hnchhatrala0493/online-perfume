...
<body>
                        ...
                        <nav id="main-nav">
                            <ul class="nav-menu sm-horizontal theme-scrollbar" id="sm-horizontal">
                                ...
                                <li> <a class="nav-link" href="#">Home <span> <i
                                    ...
                                    <div class="mega-menu">
                                        <div class="row gy-3">
                                            <div class="col-xl-3"><a class="layout-images" href="index.html"
                                                    target="_blank">
                                            ...
                                            <div class="col-xl-3"><a class="layout-images" href="layout-3.html"
                                                    target="_blank">
                                        ...
                                        <div class="row gy-4 align-items-center">
                                            <div class="col-xl-5">
                                                <div class="mega-img">
                                                    <div class="img-1"><img class="img-fluid"
                                                            src="../assets/images/mega-menu/5.jpg" alt=""></div>
                                                    <div class="img-1"><img class="img-fluid"
                                                            src="../assets/images/mega-menu/6.jpg" alt=""></div>
                                                </div>
                                            </div>
                                            <div class="col-xl-2 px-0">
                                                <ul>
                                                    ...
                                                    <li> <a href="../email-template/order-success.html">Order
                                                            Success</a></li>
                                                    <li> <a href="../email-template/reset-password.html">Reset
                                                            Password</a></li>
                                            ...
                                            <div class="col-xl-5"><img class="img-fluid"
                                                    src="../assets/images/mega-menu/1.png" alt=""></div>
                                        </div>
                                    </div>
                                </li>
                                    ...
                                    <div class="total-box">
                                        <div class="row gy-4">
                                            <div class="col-xl-4">
                                                <div class="totle-contain">
                                                    <div class="wallet-point"><img
                                                            src="../assets/images/svg-icon/wallet.svg" alt=""><img
                                                            class="img-1" src="../assets/images/svg-icon/wallet.svg"
                                                            alt=""></div>
                                            ...
                                            <div class="col-xl-4">
                                                <div class="totle-contain">
                                                    <div class="wallet-point"><img
                                                            src="../assets/images/svg-icon/coin.svg" alt=""><img
                                                            class="img-1" src="../assets/images/svg-icon/coin.svg"
                                                            alt=""></div>
                                                    <div class="totle-detail">
                                                        <h6>Total Points</h6>
                                                        <h4>500</h4>
                                            ...
                                            <div class="col-xl-4">
                                                <div class="totle-contain">
                                                    <div class="wallet-point"><img
                                                            src="../assets/images/svg-icon/order.svg" alt=""><img
                                                            class="img-1" src="../assets/images/svg-icon/order.svg"
                                                            alt=""></div>
                                                    <div class="totle-detail">
                                                        <h6>Total Orders</h6>
                                                        <h4>12</h4>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-content">
                            <div class="footer-logo"><a href="index.html"> <img class="img-fluid"
                                        src="../assets/images/logo/logo-white-1.png" alt="Footer Logo"></a></div>
                            <ul>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="from-group"> <label class="form-label">Email address</label><input
                                    class="form-control" type="email" placeholder="john.smith@example.com"></div>
                        </div>
                        <div class="col-6">
                            <div class="from-group"> <label class="form-label">Phone</label><input class="form-control"
                                    type="number" name="review[author]" placeholder="Enter your Number."></div>
                        </div>
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Address</label><textarea
                                    class="form-control" cols="30" rows="5"
                                    placeholder="Write your Address..."></textarea></div>
            ...
            <div class="modal-content">
                <div class="modal-body"> <img class="img-fluid" src="../assets/images/gif/question.gif" alt="">
                    ...
                    <div class="submit-button"> <button class="btn" type="submit" data-bs-dismiss="modal"
                            aria-label="Close">No</button><a class="btn" href="login.html">Yes</a></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-body"> <img class="img-fluid" src="../assets/images/gif/question.gif" alt="">
                    ...
                    <p>The object will establish a new permission for this object, inheriting the permission for the
                        use/group, preview.</p>
                    <div class="submit-button"> <button class="btn" type="submit" data-bs-dismiss="modal"
                            aria-label="Close">No</button><button class="btn" type="submit" data-bs-dismiss="modal"
                            aria-label="Close">Yes</button></div>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="row g-3">
                        ...
                        <div class="col-6">
                            <div class="from-group"> <label class="form-label">Name</label><input class="form-control"
                                    type="text" name="review[author]" placeholder="Enter your name."></div>
                        </div>
                        <div class="col-6">
                            <div class="from-group"> <label class="form-label" for="exampleInputEmail1">Email
                                    ...
                                    placeholder="john.smith@example.com"></div>
                        </div>
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Review Title</label><input
                                    class="form-control" type="text" name="review[author]" placeholder="Look great">
                            </div>
                        </div>
                        <div class="col-12">
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Card Holder Name</label><input
                                    class="form-control" type="text" name="name" value="Josephin water"></div>
                        </div>
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Card Number</label><input
                                    class="form-control" type="number" name="name" value="6458502535450851"></div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="from-group"> <label class="form-label">Cv</label><input class="form-control"
                                    type="number" name="cv" value="456"></div>
                        </div><button class="btn btn-submit" type="submit" data-bs-dismiss="modal"
                            aria-label="Close">Submit</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pt-0">
                    <div class="row g-3">
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Card Holder Name</label><input
                                    class="form-control" type="text" name="name" placeholder="Josephin water.."></div>
                        </div>
                        <div class="col-12">
                            <div class="from-group"> <label class="form-label">Card Number</label><input
                                    class="form-control" type="number" name="name" placeholder="645850253545XXXX..">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="from-group"> <label class="form-label">Expiry Date</label><input
                        ...
                        <div class="col-6">
                            <div class="from-group"> <label class="form-label">Cv</label><input class="form-control"
                                    type="number" name="cv" placeholder="456"></div>
                        </div><button class="btn btn-submit" type="submit" data-bs-dismiss="modal"
                            aria-label="Close">Submit</button>
                    </div>
                </div>
    ...
    <script src="../assets/js/dashboard-left-sidebar.js"></script><!-- touchspin-->
