        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="main-menu"> <a class="brand-logo" href="index.html"> <img class="img-fluid for-light"
                            src="/front/assets/images/logo/logo.png" alt="logo" /><img class="img-fluid for-dark"
                            src="/front/assets/images/logo/logo-white-1.png" alt="logo" /></a>
                    <nav id="main-nav">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 d-none d-xl-block px-0">
                                            <div class="menu-banner"> <img class="w-100 img-fluid"
                                                    src="/front/assets/images/mega-menu/banner.png" alt="" /></div>
                                        </div>
                                    </div>
                                </div>
                            </li>
                                        ...
                                        <div class="col-xl-5">
                                            <div class="mega-img">
                                                <div class="img-1"><img class="img-fluid"
                                                        src="/front/assets/images/mega-menu/5.jpg" alt="" /></div>
                                                <div class="img-1"><img class="img-fluid"
                                                        src="/front/assets/images/mega-menu/6.jpg" alt="" /></div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 px-0">
                                            <ul>
                                                <li> <a href="/front/email-template/welcome.html">Welcome
                                                        Template<span
                                                            class="badge-sm danger-color animated">Hot</span></a>
                                                </li>
                                                <li> <a href="/front/email-template/order-success.html">Order
                                                        Success</a></li>
                                                <li> <a href="/front/email-template/reset-password.html">Reset
                                                        Password</a></li>
                                                <li> <a href="/front/invoice/invoice-1.html">Invoice 1</a></li>
                                                <li> <a href="/front/invoice/invoice-2.html">Invoice 2</a></li>
                                                <li> <a href="/front/invoice/invoice-3.html">Invoice 3</a></li>
                                            </ul>
                                        </div>
                                        <div class="col-xl-5"><img class="img-fluid"
                                                src="/front/assets/images/mega-menu/1.png" alt="" /></div>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="sub_header">
                        ...
                        <ul class="justify-content-end">
                            ...
                            <li class="onhover-div shopping-cart"> <a class="p-0" href="#" data-bs-toggle="offcanvas"
