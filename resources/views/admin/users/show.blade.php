                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            ...
                                            data-dropdown-parent="#kt_menu_62cfa30ee61c2" data-allow-clear="true">
                                            <option></option>
                            ...
                            <div class="card-body pt-15">
                                ...
                                <div class="d-flex flex-stack fs-4 py-3">
                                    ...
                                    <span data-bs-toggle="tooltip" data-bs-trigger="hover"
                                        ...
                                        <a href="{{route('customers.edit',['customer'=>$customerProfile->id])}}"
                                ...
                                <div id="kt_customer_view_details" class="collapse show">
                                    <div class="py-5 fs-6">
                                        ...
                                        <div class="text-gray-600">
                                            <a href="#"
                                                class="text-gray-600 text-hover-primary">{{ $customerProfile->email}}</a>
                                        </div>
                                        <!--begin::Details item-->
                                        <!--begin::Details item-->
                                        <div class="fw-bold mt-5">Billing Address</div>
                                        <div class="text-gray-600">{{$customerProfile->address}}
                                        </div>
                                        <!--begin::Details item-->
                                        <!--begin::Details item-->
                                        ...
                                        <table class="table align-middle table-row-dashed gy-5"
                                            ...
                                            <tbody class="fs-6 fw-semibold text-gray-600">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">1381-5572</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">1265-4287</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">4482-4567</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">4717-4104</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">2810-7303</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">2397-5800</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">5653-1649</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">1466-4457</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#"
                                                            class="text-gray-600 text-hover-primary mb-1">3347-3573</a>
                                                    </td>
                                                    <!--end::Invoice=-->
                                                    <!--begin::Status=-->
                                                    <td>
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-semibold gy-1">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-gray-800">**** 7710</td>
                                                            </tr>
                                                            <tr>
                                                ...
                                                <div class="d-flex flex-wrap py-5">
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-semibold gy-1">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Number</td>
                                                                <td class="text-gray-800">**** 6599</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Expires</td>
                                                ...
                                                <div class="d-flex flex-wrap py-5">
                                                    ...
                                                    <div class="flex-equal me-5">
                                                        <table class="table table-flush fw-semibold gy-1">
                                                            ...
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Number</td>
                                                                <td class="text-gray-800">**** 4009</td>
                                                            </tr>
                                                            <tr>
                                                                <td class="text-muted min-w-125px w-125px">Expires</td>
                                            ...
                                            <table
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/customer/c_62cfa30ef25f0/not_found</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/customer/c_62cfa30ef25ec/not_found</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoice/in_8994_1194/invalid</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoice/in_7003_4424/invalid</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_6592_4228/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_2677_2053/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                                    ...
                                                    <tr>
                                                        ...
                                                        <!--end::Badge=-->
                                                        <!--begin::Status=-->
                                                        <td>POST /v1/invoices/in_3267_6802/payment</td>
                                                        <!--end::Status=-->
                                                        <!--begin::Timestamp=-->
                                        ...
                                        <table
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">21 Feb 2022,
                                                        10:10 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">10 Nov 2022,
                                                        5:20 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">24 Jun 2022,
                                                        11:30 am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">25 Oct 2022,
                                                        9:23 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">22 Sep 2022,
                                                        5:30 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">20 Jun 2022,
                                                        5:20 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">19 Aug 2022,
                                                        11:30 am</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
                                                ...
                                                <tr>
                                                    ...
                                                    <!--end::Event=-->
                                                    <!--begin::Timestamp=-->
                                                    <td class="pe-0 text-gray-600 text-end min-w-200px">20 Dec 2022,
                                                        9:23 pm</td>
                                                    <!--end::Timestamp=-->
                                                </tr>
                                                <!--end::Table row-->
