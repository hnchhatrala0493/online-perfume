                                ...
                                <div class="mb-10">
                                    ...
                                    <div>
                                        <select class="form-select form-select-solid" data-kt-select2="true"
                                            ...
                                            data-dropdown-parent="#kt_menu_62cfa2db3310c" data-allow-clear="true">
                                            <option></option>
                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                    ...
                                    <td class="text-end pe-0">
                                        <span
                                            class="fw-bold">{{ App\Models\Brand::where('id',$product->b_id)->first()->name}}</span>
                                    </td>
                                    <td class="text-end pe-0">
                                        <span
                                            class="fw-bold">{{ App\Models\Category::where('id',$product->cart_id)->first()->name}}</span>
                                    </td>
                                    <!--end::SKU=-->
                                    <!--begin::Qty=-->
                                    <td class="text-end pe-0" data-order="9">
                                        <span class="fw-bold text-warning ms-3">{{$product->quanty}}</span>
                                    </td>
                                    <!--end::Qty=-->
                                    <!--begin::Price=-->
                                    <td class="text-end pe-0">
