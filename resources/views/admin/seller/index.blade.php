                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                                    ...
                                                    data-kt-ecommerce-product-filter="product_name">{{$seller->name}}</a>
                                                <!--end::Title-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end pe-0" data-order="9">
                                        <span class="fw-bold text-warning ms-3">{{$seller->quanty}}</span>
                                    </td>
                                    <!--end::Qty=-->
                                    <!--begin::Price=-->
                                    <td class="text-end pe-0">
                                        <span class="fw-bold text-dark">{{$seller->price}}</span>
                                    </td>
                                    <!--end::Price=-->
                                    <!--begin::Action=-->
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                                            ...
                                            <div class="menu-item px-3">
                                                <a href="{{route('seller.edit',['seller'=>$seller->id])}}"
