                            ...
                            <tbody class="fw-semibold text-gray-600">
                                ...
                                <tr>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="ms-5">
                                                ...
                                                <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html"
                                                    ...
                                                    data-kt-ecommerce-product-filter="product_name">{{$order->name}}</a>
                                                <!--end::Title-->
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-end pe-0">
                                        <span
                                            class="fw-bold">{{ App\Models\Brand::where('id',$order->b_id)->first()->name}}</span>
                                    </td>
                                    <td class="text-end pe-0">
                                        <span
                                            class="fw-bold">{{ App\Models\Category::where('id',$order->cart_id)->first()->name}}</span>
                                    </td>
                                    <!--end::SKU=-->
                                    <!--begin::Qty=-->
